    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Form Edit Foto User</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <!--<form class="form-horizontal" action="registrasi/post">-->
            <?php echo form_open_multipart('user/update_foto', array('class' => 'form-horizontal')); ?>
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $username ?>" placeholder="Username" readonly>
                    </div>
                </div>
                <div class="form-group">
