<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo base_url('/dashboard1'); ?>" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>A</b>PP</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>AdminHendi</b>PP</span>
            </a>
            <!-- Header Navbar: style can be found in header.less -->
            <nav class="navbar navbar-static-top" role="navigation">
                <!-- Sidebar toggle button-->
                <a href="<?php echo base_url('/dashboard1'); ?>" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo base_url('assets/admin_lte/img/user4-128x128.jpg'); ?>" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
