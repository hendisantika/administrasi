...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page | ANA (Administrasi Anggota Pemuda Persis)</title>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="block clearfix">
                                                            <span class="block input-icon input-icon-right">
                                                                <input type="text"  name="username" id="username" autofocus="true" class="form-control"  placeholder="Username atau Email" />
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="toolbar clearfix">
                                                            <div>
                                                                <a href="<?php echo site_url('user/forget_password'); ?>" class="forgot-password-link">
