...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Performa Jam'iyyah tingkat PD </li>
        </ol>
    </section>
            ...
            <div class="col-sm-12">
                <div class="box box-info">
                    <div class="box box-header">
                        <h3>Form Input Performa Jam'iyyah tingkat Pimpinan Daerah</h3>
                    </div>
                    <div class="box box-body">
                        ...
                        <h3 align='center'><bold>UNTUK TINGKAT PIMPINAN DAERAH (PD)</bold></h3>
                        <hr>
                        <h3 align='left'>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ol>
                                    ...
                                    <li>Prinsip pengisian IPJ ini adalah untuk mengetahui dan memahami kondisi riil dan objektif dari setiap PD, sehingga bisa diketahui potensi kekuatan apa saja yang dimiliki PD juga bisa diidentifikasi masalah dan hambatan yang dihadapi oleh PD sehingga bisa diformulasikan dengan tepat solusi dari setiap permasalahan tersebut.</li>
                                </ol>
                            </div>
                        </div>

                        <?php echo form_open('jamiyyah/save_performa_pd'); ?>
                        <div class="form-group">
                            <label for="no_pd" class="col-sm-2 control-label">Nomor PD</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="kd_pd" id="kd_pd" placeholder="Nomor PD" readonly="" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nama_pd" id="nama_pd" placeholder="Nama PD" readonly="">
                            </div>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModalPD"><i class="glyphicon glyphicon-search"> Cari</i></button>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ketua_pd" class="col-sm-2 control-label">Nama Ketua PD</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="ketua_pd" name="ketua_pd" placeholder="Nama Ketua PD">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="no_hp" class="col-sm-2 control-label">Nomor HP Ketua PD</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Nomer HP Ketua PD">
                            </div>
                        </div>
                        <br>&nbsp;
                        <div class="box box-success">
                            ...
                            <div class="form-group">
                                ...
                                <ol>
                                    ...
                                    <div class="col-sm-12">
                                        <li>Apakah PD memiliki kegiatan rutin (minimal tiga kali sebulan)?</li>
                                        <div class="col-sm-12">
                                            <label>
                                    ...
                                    <div class="col-sm-12">
                                        <li>Bagaimana rata-rata kehadiran anggota dalam kegiatan rutin PD? (sertakan bukti fisik)</li>
                                        <div class="col-sm-12">
                                            <label>
                                    ...
                                    <div class="col-sm-12">
                                        <li>Apakah ada kegiatan insidental di PD?</li>
                                        <div class="col-sm-12">
                                            <label>
                                    ...
                                    <div class="col-sm-12">
                                        <li>Bagaimana rata-rata kehadiran anggota dalam kegiatan insidental PD? (sertakan bukti fisik)</li>
                                        <div class="col-sm-12">
                                            <label>
                                    ...
                                    <div class="col-sm-12">
                                        <li>Bagaimana publikasi/undangan pada setiap kegiatan PD?</li>
                                        <div class="col-sm-12">
                                            <label>
                            ...
                            <div class="form-group">
                                ...
                                <ol>
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki sekretariat yang definitif?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD memiliki perangkat kesekretariatan (komputer/mesin tik)?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Agenda Surat Masuk?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Agenda Surat Keluar?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Induk Anggota?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki kop surat?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki stempel?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah surat resmi PD sudah sesuai dengan Pedoman Administrasi (bentuk, format, penomoran, dll)?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Agenda Kegiatan?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Notulen Rapat/Musyawarah?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD sudah memiliki Buku Daftar Tamu?</li>
                                            <div class="col-sm-12">
                                                <label>
                            ...
                            <div class="form-group">
                                ...
                                <ol>
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah masa jihad PD sesuai masa jihad yang tertuang dalam SK pengesahan?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah SK pengesahan PD/tasykil masih ada?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Berapa kali PD melakukan musyawarah kerja selama masa jihad?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah hasil musyawarah kerja tersebut disosialisasikan kepada PD Persis?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah hasil musyawarah kerja tersebut disosialisasikan kepada PD Persistri?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah hasil musyawarah kerja tersebut disosialisasikan kepada PD Pemudi?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Berapa kali PD melakukan rapat koordinasi dengan PJ dalam satu tahun?</li>
                                            <div class="col-sm-12">
                                                <label>
                            ...
                            <div class="form-group">
                                ...
                                <ol>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD rutin setiap bulan menjemput iuran anggota?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD memiliki catatan lengkap tentang tagihan iuran anggota?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD mengusahakan sumber-sumber pemasukan keuangan lain selain iuran anggota?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Apakah PD memiliki pembukuan keuangan?</li>
                                            <div class="col-sm-12">
                                                <label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <li>Bagaimana kondisi neraca/saldo tahunan PD?</li>
                                            <div class="col-sm-12">
                                                <label>
                            ...
                            <div class="box-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success btn-block btn-lg" name="submit"><i class="fa fa-save"> Save Indeks Performa Jam'iyyah PD</i></button>
                                    </div>
                                </div>
                            </div><!-- /.box-footer -->
                        </div>
