    ...
    <section class="content">
        ...
        <div class="box box-info wrap_auto">
            <div class="box-header with-border">
                <h3 class="box-title">Form Input Data Monografi Jam'iyyah tingkat PC</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body content_auto">
                ...
                <h2 align='center'><bold>PC PEMUDA PERSATUAN ISLAM</bold></h2>
                <hr>
                <?php echo form_open_multipart('jamiyyah/save_monografi_pc', array('class' => 'form-horizontal')); ?>
